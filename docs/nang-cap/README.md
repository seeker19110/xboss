...
> **M105 (`M105-dinh-cao-2d.md`)** — đợt "đỉnh cao 2D": block tự do (thêm thẳng + lịch sử 5 bản/rollback), auto-routing 2D, ngắt nét giao chéo, revision cloud + so sánh 2 revision, nhân bản tầng điển hình, riser, dim+tag tự động, in PDF hàng loạt. 8 PR. **Approved for implementation 2026-08-25.**
> **M106 (`M106-hoan-thien-2d-chung-ong.md`)** — hoàn thiện 2D chung + ống/gió: cao độ EL/BOD, legend tự sinh, clash xref kiến trúc/kết cấu, bản vẽ lỗ chờ BW, annotative, giá đỡ tự rải, độ dốc ống thoát, ống gió 2 nét + KL tôn. 8 PR, rule pack v10. **Approved for implementation 2026-08-25.**
> **M107 (`M107-mepf-fire-electric.md`)** — MEPF trọn nghĩa: sprinkler rải theo coverage + phép kiểm, điện 2D (đi dây/mã mạch, KL cáp theo mạch, panel schedule, sơ đồ 1 sợi). 6 PR, rule pack v11. **Approved for implementation 2026-08-25.**
