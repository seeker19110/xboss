...
>
> **Chưa triển khai (theo thứ tự thi hành đã chốt):** M53 PR4 → M56 PR2 → M55 → M58 PR3 → M54 GĐ1 → M59 — xem bảng "Đặc tả chờ triển khai" bên dưới (M53 PR1-3, M57 PR1, M51 GĐ0 đã merge). Một số việc **hoãn có chủ đích** (M49 PR3 SSO OIDC merge nhưng flag tắt, M60 major deps) — xem `PROGRESS.md` mục "Việc tạm hoãn".
>
...
3. **M56 PR2** — bắt buộc 2FA theo vai trò (nhỏ, nền PR1 đã chạy).
