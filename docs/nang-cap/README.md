...
>
> **Chưa triển khai (theo thứ tự thi hành đã chốt):** M55 → M58 PR3 → M54 GĐ1 → M59 — xem bảng "Đặc tả chờ triển khai" bên dưới (M53 toàn bộ 4 PR, M57 PR1, M51 GĐ0, M56 toàn bộ 2 PR đã xong). Một số việc **hoãn có chủ đích** (M49 PR3 SSO OIDC merge nhưng flag tắt, M60 major deps) — xem `PROGRESS.md` mục "Việc tạm hoãn".
>
