...
| `M58-qr-offline-hien-truong.md` | QR tem in `/r/<kind>/<id>` + offline queue IndexedDB ảnh/nhật ký                                | ⚠️ PR1 xong (resolve `/r/[kind]/[id]` + tem in); **PR2/PR3 (offline queue) chưa** | KHÔNG có migration                                                                                                       |
