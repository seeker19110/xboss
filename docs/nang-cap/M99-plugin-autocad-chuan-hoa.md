...
| Nền build         | 1 bản duy nhất vs đa nền                                             | **ĐÃ CHỐT: 1 bản duy nhất — AutoCAD 2026, .NET 10 (cập nhật 2026-08-25; trước đó .NET 8). Không hỗ trợ 2021–2024. Xem §9.1                                                                                                                 |
...
Thư mục: `plugin-autocad/` — `XBoss.Cad.sln`, `XBoss.Cad.Core/` (net8.0; phụ thuộc duy nhất: ClosedXML), `XBoss.Cad.Acad/` (net10.0-windows (cập nhật 2026-08-25); tham chiếu ObjectARX 2026 qua thuộc tính MSBuild `AcadSdkDir`, `CopyLocal=false`; **không build trong CI**), `XBoss.Cad.Tests/` (xunit, chỉ tham chiếu Core), `bundle/PackageContents.xml`, `README.md` (build/cài đặt/xác minh runtime §9.1).
...
**Quyết định (2026-08-22): plugin chỉ hỗ trợ AutoCAD 2026. Một bản build duy nhất trên .NET 10 (cập nhật 2026-08-25 từ .NET 8). Không hỗ trợ 2021–2024, không đa nền.**
...
| PR2      | `api_tokens` + ghép thiết bị + quản lý/thu hồi trên web + `XBOSS_LOGIN` (**vùng rủi ro cao — rà `docs/audit.md`**)                                                                                                                                                                               | `complex`  | xong                                                                                               |
| PR5      | `plugin-upload` + kiểm định `ezdxf` trong worker + tạo revision + `XBOSS_UPLOAD`                                                                                                                                                                                                                 | `spec`     | xong                                                                                               |
