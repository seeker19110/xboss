...
3. ~~tracking grid~~ → **xong** (axe desktop+mobile, view mặc định). **Tiếp:** payments → my-tasks → materials…, mỗi trang một spec authed. Gộp **~10 nút accent FAIL** (§3) khi chạm trang chứa.
