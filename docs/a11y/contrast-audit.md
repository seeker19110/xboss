...
| ✅ P3 | `app/admin/page.tsx`                                                                                                                                                    |    18 |     5 |    23 | **Xong** — axe desktop (3 tab: Phân công/Lịch sử/Traffic) + mobile (tab Phân công). Sửa: meta hệ/badge/cell bảng `zinc-500/600`→`zinc-400`, +`aria-label` 2 nút toggle + UserSelect. Tab header không reachable trên mobile (header tràn — ngoài phạm vi) |
