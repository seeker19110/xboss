...
- `idx_tasks_end_date`: INDEX idx_tasks_end_date ON public.tasks USING btree (end_date)
...
- `idx_tasks_start_date`: INDEX idx_tasks_start_date ON public.tasks USING btree (start_date)
