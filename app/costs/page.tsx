...
export default function CostsRedirectPage() {
  ...
  useEffect(() => {
    router.replace("/commercial?tab=contracts&sub=costs");
  }, [router]);
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-4">
        ...
        <div className="space-y-1">
          <h2 className="text-lg font-bold text-zinc-100">
            Đang chuyển tiếp đến Hạn Mức Chi Phí & Dự Toán...
          </h2>
          <p className="text-xs text-zinc-400">
            Hạn mức chi phí đã được hợp nhất tại <b>/commercial?tab=contracts&sub=costs</b>.
          </p>
        </div>
        <a
