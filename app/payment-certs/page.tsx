            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              {canManage && (
                <button
                  ...
                  className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 active:scale-[0.98] disabled:opacity-50 px-3.5 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold transition shrink-0 text-white shadow-sm h-10"
                >
