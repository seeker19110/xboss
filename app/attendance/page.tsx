...
export default function AttendanceRedirectPage() {
  ...
  useEffect(() => {
    router.replace("/site?tab=tasks-diary&sub=attendance");
  }, [router]);
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-4">
        ...
        <div className="space-y-1">
          <h2 className="text-lg font-bold text-zinc-100">
            Đang chuyển tiếp đến Chấm Công Hiện Trường...
          </h2>
          <p className="text-xs text-zinc-400">
            Chấm công và điểm danh thầu phụ đã được hợp nhất tại{" "}
            <b>/site?tab=tasks-diary&sub=attendance</b>.
          </p>
        </div>
        <a
          href="/site?tab=tasks-diary&sub=attendance"
