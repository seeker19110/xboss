          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-5 backdrop-blur-sm">
              ...
              <form onSubmit={handleCreateEnvelope} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="flex w-full items-center justify-center gap-2 rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-emerald-500"
                >
                  <Send size={16} />
                        ...
                        {s.status === "ready" && (
                          <div className="mt-4 rounded-lg bg-zinc-900 border border-zinc-700/60 p-4 space-y-3">
                            ...
                            <button
                              ...
                              className="w-full rounded bg-emerald-600 py-2 text-xs font-bold text-white hover:bg-emerald-500 transition-colors"
                            >
