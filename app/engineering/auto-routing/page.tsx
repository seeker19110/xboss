        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-lg bg-sky-700 px-3 py-1 text-xs font-medium text-on-accent hover:bg-sky-800 disabled:opacity-50"
                  >
                    <Play size={11} />
          ...
          <div className="space-y-4 lg:col-span-1">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full rounded-lg bg-emerald-700 py-1.5 text-xs font-medium text-on-accent hover:bg-emerald-800"
              >
