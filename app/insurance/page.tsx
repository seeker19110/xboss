...
export default function InsuranceRedirectPage() {
  ...
  useEffect(() => {
    router.replace("/commercial?tab=contracts&sub=insurance");
  }, [router]);
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-4">
        <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-400">
          <Umbrella className="w-10 h-10 animate-pulse" />
        </div>
        <div className="space-y-1">
          <h2 className="text-lg font-bold text-zinc-100">
            Đang chuyển tiếp đến Bảo Hiểm & Bảo Lãnh...
          </h2>
          <p className="text-xs text-zinc-400">
            Bảo hiểm công trình và bảo lãnh ngân hàng đã được hợp nhất tại{" "}
            <b>/commercial?tab=contracts&sub=insurance</b>.
          </p>
        </div>
        <a
