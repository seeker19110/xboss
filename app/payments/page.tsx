...
export default function PaymentsRedirectPage() {
  ...
  useEffect(() => {
    router.replace("/commercial?tab=ipc-payments&sub=payments");
  }, [router]);
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-4">
        ...
        <div className="space-y-1">
          <h2 className="text-lg font-bold text-zinc-100">
            Đang chuyển tiếp đến Sổ Đề Nghị Thanh Toán...
          </h2>
          <p className="text-xs text-zinc-400">
            Đề nghị thanh toán chi phí và tạm ứng đã được hợp nhất tại{" "}
            <b>/commercial?tab=ipc-payments&sub=payments</b>.
          </p>
        </div>
        <a
