      ...
      {canManage && (
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={save}
            disabled={saving}
            className="ml-auto flex items-center gap-2 bg-emerald-700 hover:bg-emerald-800 disabled:opacity-50 px-3 py-1.5 rounded-lg text-xs font-semibold text-on-accent"
          >
