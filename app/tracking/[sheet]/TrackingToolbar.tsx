...
export function TrackingToolbar({
  ...
  return (
    <div className="px-4 sm:px-6 py-3 flex flex-wrap gap-2.5 items-center border-b border-zinc-800 bg-zinc-950/60 backdrop-blur-md no-print">
      <div className="relative flex-1 sm:flex-initial min-w-[180px] max-w-xs">
        ...
        <input
          ...
          className="w-full bg-zinc-900 border border-zinc-800 rounded-xl pl-9 pr-3 py-2 text-xs sm:text-sm text-zinc-100 placeholder:text-zinc-500 outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/50 transition h-10"
        />
      </div>
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <select
          ...
          className="bg-zinc-900 border border-zinc-800 text-zinc-200 rounded-xl px-3 py-2 text-xs sm:text-sm outline-none focus:border-emerald-500 transition h-10"
        >
