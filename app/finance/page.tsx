...
export default function FinanceRedirectPage() {
  ...
  useEffect(() => {
    router.replace("/commercial?tab=cashflow-esign");
  }, [router]);
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-4">
        ...
        <div className="space-y-1">
          <h2 className="text-lg font-bold text-zinc-100">
            Đang chuyển tiếp đến Tài Chính, Dòng Tiền & Ký Số...
          </h2>
          <p className="text-xs text-zinc-400">
            Sổ kế toán và dòng tiền S-Curve đã được hợp nhất tại{" "}
            <b>/commercial?tab=cashflow-esign</b>.
          </p>
        </div>
        <a
