...
export default function ScheduleControlRedirectPage() {
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-4">
        ...
        <div className="space-y-1">
          <h2 className="text-lg font-bold text-zinc-100">
            Đang chuyển tiếp đến Kiểm Soát Tiến Độ WBS & Đường Găng...
          </h2>
          <p className="text-xs text-zinc-400">
            Kiểm soát đường găng và nguyên nhân trễ đã được hợp nhất tại <b>/schedule?tab=wbs</b>.
          </p>
        </div>
        <a
