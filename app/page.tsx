...
import { AlertTriangle, TrendingUp, Clock, Upload } from 'lucide-react';
              ...
              <tbody>
                {data?.delayedTasks.map((t, i) => (
                  <tr key={t.id} className="border-b border-zinc-800/50 hover:bg-zinc-800/50">
                    ...
                    <td className="p-3"><span className="px-2 py-0.5 bg-red-950 text-red-400 rounded text-xs">Đang Trễ</span></td>
                  </tr>
                ))}
