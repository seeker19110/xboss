...
export default function OrderContent({ isEmbed = false }: { isEmbed?: boolean }) {
  ...
  const orderGridColumns: GridColumn<OrderRow>[] = useMemo(() => [
    ...
    { key: 'qtyBoq', label: 'ĐM BOQ', width: 70, type: 'readonly',
      get: r => r.qtyBoq },
    { key: 'qtyPlanned', label: 'ĐM Tháp', width: 75, type: 'readonly',
      get: r => r.qtyPlanned },
    { key: 'qtyUsed', label: 'Đã dùng', width: 70, type: 'readonly',
      get: r => r.qtyUsed },
    { key: 'orderQty', label: 'KL đặt hàng', width: 90, type: 'number',
        ...
        <div className="a4-page bg-white text-black w-[210mm] min-h-[297mm] shadow-2xl p-[14mm]">
          ...
          <div className="mb-3 space-y-2 text-[10px]">
            <div className="bg-sky-50 border border-sky-200 rounded px-3 py-2 space-y-1">
              ...
              <div className="grid gap-y-1 [&>*]:min-w-0" style={{ gridTemplateColumns: '1fr 180px', columnGap: '24px' }}>
