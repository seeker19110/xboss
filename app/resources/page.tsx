...
export default function ResourcesRedirectPage() {
  ...
  useEffect(() => {
    router.replace("/site?tab=tasks-diary&sub=resources");
  }, [router]);
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-4">
        ...
        <div className="space-y-1">
          <h2 className="text-lg font-bold text-zinc-100">
            Đang chuyển tiếp đến Quản Lý Tải Nhân Lực...
          </h2>
          <p className="text-xs text-zinc-400">
            Tài nguyên và biểu đồ tải nhân lực đã được hợp nhất tại{" "}
            <b>/site?tab=tasks-diary&sub=resources</b>.
          </p>
        </div>
        <a
