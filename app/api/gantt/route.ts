...
// GET /api/gantt?he=<disciplines.code> → work packages có ngày bắt đầu/kết thúc cho
// timeline, kèm phụ thuộc (deps), nhóm bị "chặn" (blocked) và đường găng CPM (critical).
// `he` lọc tập package trước khi tính CPM → đường găng tính trong phạm vi đã lọc (M36).
