...
// GET /api/proposals?kind=&status= — danh sách đề xuất, scoped theo dự án đang chọn
// (M22). Admin/PM/BCH thấy tất cả; vai trò còn lại chỉ thấy đề xuất mình tạo (spec M19).
