...
// scope: "global" (mặc định, giữ hành vi cũ — áp toàn hệ thống) | "project" (chỉ áp dự án
// đang chọn, M22). Admin bật (false→true, ở phạm vi global) → tạo notification `nav_enabled`
