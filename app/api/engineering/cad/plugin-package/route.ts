...
//
// M118 PR3 (FR3): nhận thêm Bearer token scope 'cad' — đúng khuôn rule-pack/route.ts — để
// plugin tự gọi lúc XBOSS_RULEPACK/XBOSS_BANG so version của mình với server, không cần mở
// trình duyệt. Bearer kiểm TRƯỚC, không có/sai mới rơi về phiên đăng nhập web.
