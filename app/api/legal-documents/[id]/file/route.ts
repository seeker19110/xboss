...
// GET /api/legal-documents/:id/file — tải file chính của hồ sơ pháp lý. Xem: mọi vai
// trò đăng nhập. Scoped theo dự án đang chọn (M22).
export async function GET(
  ...
  const doc =
    projectId != null
      ...
      : undefined;
  if (!doc?.fileName) return NextResponse.json({ error: "Chưa có file đính kèm" }, { status: 404 });
