...
| 1b   | `XBOSS_TUYEN_GOIY`  | _(tùy chọn, M117)_ Không muốn vẽ tay từ đầu: gõ mã sơ đồ nguyên lý đã chốt trên web → chọn hệ/loại tuyến/cỡ mặc định + cao độ tầng → bấm **điểm nguồn** trên mặt bằng. Plugin ghép thiết bị của sơ đồ với block trên bản vẽ rồi sinh **tuyến tim nháp** (layer `XBOSS-GOIY`) theo hành lang. Sửa nháp thoải mái rồi đi tiếp bước 2. Chạy lại không nhân đôi; dọn sạch bằng `XBOSS_TUYEN_GOIY_XOA`. Cần có hành lang trước (`XBOSS_VE_HANHLANG`) |
