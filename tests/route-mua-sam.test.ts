...
// sẽ không thấy dự án nào. Mỗi user ở đây được GÁN THẲNG vào dự án của nó (dangNhapDuAn) —
// test tự chủ, chạy đúng ở mọi thứ tự (bám đúng tests/route-tai-chinh.test.ts).
