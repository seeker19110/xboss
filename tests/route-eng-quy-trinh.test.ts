...
// W1). (route suggestions/route.ts, suggestions/[id]/route.ts, suggestions/[id]/decide/route.ts,
// swarm/** đã bị xoá 2026-09-21; route/lib autonomy/** đã bị xoá 2026-09-22 (module
// `engineering-autonomy` — 1/6 module `thuNghiem: true` không ai bật, xem PROGRESS.md) —
// `decideSuggestion`/`ingestIntelligencePackage` trong lib/ky-thuat/engineering-intel.ts vẫn
// dùng bởi Gate 0 Workflow ENG-3, GIỮ NGUYÊN):
...
// engineering-os.md (agent-sessions).
