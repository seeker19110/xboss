...
// swarm/** đã bị xoá 2026-09-21, xem PROGRESS.md — `decideSuggestion`/`ingestIntelligencePackage`
// trong lib/ky-thuat/engineering-intel.ts vẫn dùng bởi Gate 0 Workflow ENG-3, GIỮ NGUYÊN):
