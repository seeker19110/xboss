...
// (listSuggestions/getSuggestion — phục vụ riêng trang/route /engineering/suggestions (ENG-2) —
// đã bị xoá cùng route/UI đó. decideSuggestion bên dưới vẫn dùng chung với Gate 0 workflow ENG-3.)
