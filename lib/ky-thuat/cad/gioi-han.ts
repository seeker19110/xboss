 ...
 *
 * Chọn 150 MB chứ không phải con số nhỏ hơn: bản vẽ MEPF toàn tầng ở dạng DXF ASCII thường
 * 50–120 MB, đặt trần sát quá là chặn đúng người dùng thật. Đây là van an toàn chống tràn bộ
