...
// (Mục 1-3: FIDIC Clause Mapping, Time-Bar Compliance Checker, Time Impact Analysis & Dossier
// Generator của tính năng "FIDIC 28-day EOT Claims Dossier" (M79, /engineering/fidic-claims) đã bị
// xoá cùng route/UI — chỉ còn TIA Claim Engine độc lập (M94) dưới đây phục vụ /engineering/fidic-tia.)
...
// (Mục 5: General FIDIC Claim Database Persistence — createFidicClaim/listFidicClaims, phục vụ
// riêng route /api/engineering/fidic/claims — đã bị xoá cùng tính năng M79.)
