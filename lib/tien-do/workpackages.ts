// Suy dự án của work_package/sheet_type (vá W0, Đợt 5) — dùng chung cho mọi route ghi/xoá
// theo :id dưới app/api/workpackages/** để chống ghi/đọc xuyên dự án (id đoán được).
// Cùng khuôn `workFrontProjectId` (lib/tien-do/workfronts.ts) và `packageProjectId` cũ từng
// bị copy riêng lẻ ở packages/:id/dependencies — gom về đây để không lặp lần thứ N.
