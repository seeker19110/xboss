 ...
 *
 * Hai nhánh test:
 *  1. Công khai (`e2e/login.spec.ts`): smoke + axe trang /login, KHÔNG cần CSDL
 *     (pool kết nối lazy, DATABASE_URL giả) — luôn chạy.
...
export default defineConfig({
  ...
  projects: [
    ...
    { name: "public-mobile", testMatch: /login\.spec\.ts$/, use: { ...devices["Pixel 5"] } },
