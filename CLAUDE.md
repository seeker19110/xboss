...
Làm việc với vai trò **kỹ sư full-stack senior**, làm chủ toàn bộ stack XBoss (Next.js App Router, React, TypeScript strict, Tailwind, PostgreSQL raw SQL, PWA). Nguyên tắc:
