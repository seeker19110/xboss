...
const WHITELIST: Record<string, string> = {
  ...
  "admin/alert-rules": "Admin-only (CAN.manageAlertRules) — projectId là thuộc tính rule, không phải phạm vi lọc.",
  "admin/api-keys": "Admin-only (CAN.manageIntegrations) — projectId là thuộc tính key, không phải phạm vi lọc.",
  "admin/approval-flows": "Admin-only (CAN.manageApprovalFlows) — projectId là thuộc tính flow, không phải phạm vi lọc.",
  "admin/custom-fields": "Admin-only (CAN.manageCustomFields) — projectId là thuộc tính field, không phải phạm vi lọc.",
  "admin/feature-flags": "Admin-only (CAN.manageFeatureFlags) — projectId là dự án được bật/tắt module, do Admin chỉ định.",
  "admin/integrations": "Admin-only (CAN.manageIntegrations) — projectId là thuộc tính tích hợp, không phải phạm vi lọc.",
  "admin/role-permissions": "Admin-only (CAN.manageUsers) — projectId là phạm vi override quyền do Admin chỉ định.",
  "admin/webhooks": "Admin-only (CAN.manageIntegrations) — projectId là thuộc tính webhook, không phải phạm vi lọc.",
};
